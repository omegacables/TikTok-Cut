...
GENRES: list[Genre] = [
    ...
    Genre(
        ...
        "『音の盛り上がり』のピーク（銃声・キル音・確キル）を最優先に選ぶ。1キル〜連続キルの短い見せ場に"
        "絞り、テンポ重視で短め（目安12〜25秒。ただし10秒未満は作らない）。雑談・移動・漁りだけの区間は選ばない。",
        length=(12.0, 26.0), prefer_loud=True,
    ),
    Genre(
        "godplay", "神プレイ・上手い", "✨",
    ...
    Genre(
        ...
        "驚く直前の油断から、驚いた反応までをワンセットで短く（目安12〜25秒。10秒未満は作らない）切る。",
        length=(12.0, 26.0), prefer_loud=True,
    ),
    Genre(
        "chaos", "ハプニング・カオス", "🌀",
